#!/usr/bin/env python
#
# catxas documentation build configuration file, created by
...
version = catxas.__version__
# The full version, including alpha/beta/rc tags.
release = catxas.__version__
...
latex_documents = [
    (master_doc, 'catxas.tex',
     'catXAS Documentation',
     'Adam S. Hoffman', 'manual'),
]
